export const PWS_CLASS_FIELDS = [
  ...
  { key: "std1", label: "Class I", group: "Primary & Secondary" },
  { key: "std2", label: "Class II", group: "Primary & Secondary" },
  { key: "std3", label: "Class III", group: "Primary & Secondary" },
  { key: "std4", label: "Class IV", group: "Primary & Secondary" },
  { key: "std5", label: "Class V", group: "Primary & Secondary" },
  { key: "std6", label: "Class VI", group: "Primary & Secondary" },
  { key: "std7", label: "Class VII", group: "Primary & Secondary" },
  { key: "std8", label: "Class VIII", group: "Primary & Secondary" },
  { key: "std9", label: "Class IX", group: "Primary & Secondary" },
  { key: "std10", label: "Class X", group: "Primary & Secondary" },
] as const;
